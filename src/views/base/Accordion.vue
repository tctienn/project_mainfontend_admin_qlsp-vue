<template>
  <CRow>
    <CCol :xs="12">
      ...
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Accordion</strong> <small>Flush</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
      ...
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Accordion</strong> <small>Always open</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
            Add <code>always-open</code> property to make accordion items stay open when another
            item is opened.
          </p>
