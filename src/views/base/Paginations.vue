<template>
  <CRow>
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <p class="text-body-secondary small">
            ...
            <code>aria-label</code> for the <code>&lt;nav&gt;</code> to reflect its purpose. For
            example, if the pagination component is used to navigate between a set of search
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Pagination</strong> <small>Sizing</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Pagination</strong> <small>Alignment</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
