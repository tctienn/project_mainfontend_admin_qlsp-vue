<template>
  <CRow>
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Navs</strong> <small>Base navs</small> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Navs</strong> <small>Horizontal alignment</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Navs</strong> <small>Vertical</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Navs</strong> <small>Tabs</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Navs</strong> <small>Pills</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Navs</strong> <small>Fill and justify</small> </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
          ...
          <p class="text-body-secondary small">
            ...
            <code>layout=&#34;justified&#34;</code>. All horizontal space will be occupied by nav
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Navs</strong> <small>Tabs with dropdowns</small> </CCardHeader>
        <CCardBody>
    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader> <strong>Vue Navs</strong> <small>Pills with dropdowns</small> </CCardHeader>
        <CCardBody>
